...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'score', name: 'Score', meta: { name: '积分信息' }, component: () => import('../views/manager/Score') },
      { path: 'information', name: 'Information', meta: { name: '资源管理' }, component: () => import('../views/manager/Information') },
      ...
      { path: 'fileOrder', name: 'FileOrder', meta: { name: '资源兑换' }, component: () => import('../views/manager/FileOrder') },
    ]
  },
  {
    path: '/front',
    ...
    children: [
      ...
      { path: 'fileOrder', name: 'FileOrder', meta: { name: '历史资源' }, component: () => import('../views/front/FileOrder') },
    ]
  },
