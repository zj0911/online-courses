<template>
  <div>
    ...
    <div style="display: flex; margin: 10px 0">
      <div style="width: 50%; margin-right: 5px" class="card" >
      ...
      <div style="width: 50%; height: 300px; margin-left: 5px" class="card" id="coursePie"></div>
    </div>

    <div style="display: flex; margin: 10px 0px">
      <div style="width: 50%; height: 400px; margin-right: 5px" class="card" id="userPie"></div>
      <div style="width: 50%; height: 400px; margin-left: 5px" class="card" id="bar"></div>
    </div>
