<template>
  <div class="main-content">
    <el-card style="width: 50%; margin: 30px auto">
      ...
      <el-form size="small" :model="user" label-width="80px" style="padding-right: 20px;">
    ...
    <!--  修改密码  -->
    <el-dialog title="修改密码" :visible.sync="dialogVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
    ...
    <!--  账户充值  -->
    <el-dialog title="充值信息" :visible.sync="rechargeVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
      <el-form>
        <el-form-item label="充值说明">
          <span style="color: #dd6161">充值一次性满500元可成为会员</span>
        </el-form-item>
        <el-form-item label="充值说明">
          <el-input v-model="account" placeholder="输入充值金额"></el-input>
        </el-form-item>
