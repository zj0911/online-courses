...
public class InformationService {
    ...
    public void updateById(Information information) {
        if(RecommendEnum.YES.status.equals(information.getRecommend())){ //将当前设为推荐
            Information info = informationMapper.selectRecommend();
            if(ObjectUtil.isNotEmpty(info) && !info.getId().equals(information.getId())){
