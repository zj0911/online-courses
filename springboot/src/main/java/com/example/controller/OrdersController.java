...
public class OrdersController {
    ...
    public Result getPie() {
        ...
        Map<String,Double> collect = ordersList.stream().filter(x -> ObjectUtil.isNotEmpty(x.getCourseType())).collect(Collectors.groupingBy(Orders::getCourseType, Collectors.reducing(0.0,Orders::getPrice, Double::sum)));
